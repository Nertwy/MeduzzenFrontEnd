<template>
  <section>
    ...
    <BaseInput
      :label="'Show your companies'"
      class="checkbox"
      type="checkbox"
      v-model="your_companies"
    />
    <Table_With_Pagination
      :update-func="
        (user) => updateUser(user, 'api/companies/', 'updateCompanyFromList')
      "
      :data="companyList"
      ...
      :delete-text="'All data about company will be lost!'"
      @pass-id=""
    />
    <CompanyForm />
  </section>
...
const companyList = computed<TableCompany[]>(() =>
