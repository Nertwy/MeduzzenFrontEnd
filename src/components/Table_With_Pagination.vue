<template>
    <section>
        <table class="table table-zebra">
            <thead>
                <tr>
                    <th v-for="(value, index) in Object.keys(props.data[0] as object)" :key="index">{{ value }}</th>
                    <th>Edit</th>
                    <th>Delete</th>
                </tr>
            </thead>
                    ...
                    <td>
                        <ModalWindow :btn-open-text="'Delete'" :title="'Delete user?'"
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <Delete_Button :delete-function="() => deleteFunc(value.id, userPassword)" />
                            </div>
...
type Props = {
    ...
    data: T[]
    pageChangeFunc: (page: number) => Promise<PageWith<T> | undefined>
}
